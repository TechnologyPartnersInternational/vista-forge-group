...
export const services = [
  {
    ...
    subServices: [
      { title: "Environmental Planning & Management", slug: "environmental-planning-management" },
      { title: "Environmental Compliance Monitoring (ECM)", slug: "environmental-compliance-monitoring" },
      { title: "Environmental Site Assessment & Characterization", slug: "environmental-site-assessment" },
      { title: "Climate Change, Sustainability & GHG Reporting", slug: "climate-change-sustainability" },
      { title: "Health, Social Engagement, & Resettlement", slug: "health-social-engagement" },
      { title: "Air Quality & Acoustics", slug: "air-quality-acoustics" },
      { title: "Clean-Up And Remediation Services", slug: "cleanup-remediation" },
      { title: "Hydrological & Hydrogeological Services", slug: "hydrological-services" },
      { title: "Geophysical And Geotechnical Services", slug: "geophysical-services" },
      { title: "Geographic Information System (GIS) Services", slug: "gis-services" },
    ]
  },
  {
    id: "laboratory",
    ...
    hasDetailedPage: true,
    subServices: [
      { title: "General Laboratory Services", slug: "general-laboratory-services" },
      { title: "Remote & Mobile Laboratory Services", slug: "remote-mobile-laboratory" },
      { title: "Eco-Toxicity, Bioaccumulation & Biodegradability", slug: "eco-toxicity" },
      { title: "Production Chemistry, Petroleum Product Testing", slug: "production-chemistry" },
      { title: "Geochemical/Fingerprinting", slug: "geochemical-fingerprinting" },
    ]
  },
  {
    id: "waste-management",
    ...
    hasDetailedPage: true,
    subServices: [
      { title: "Integrated Solid Waste Management (ISWM) system", slug: "integrated-solid-waste" },
      { title: "Incinerator", slug: "incinerator" },
      { title: "Thermal Desorption", slug: "thermal-desorption" },
    ]
  },
  {
    id: "digital",
    ...
    hasDetailedPage: true,
    subServices: [
      { title: "Security & Software Solutions", slug: "security-software-solutions" },
      { title: "Data Management & Reporting", slug: "data-management-reporting" },
    ]
  },
  {
    id: "training",
    ...
    hasDetailedPage: true,
    subServices: [
      { title: "ESG training", slug: "esg-training" },
      { title: "Environmental laboratory training", slug: "environmental-laboratory-training" },
      { title: "Customized training", slug: "customized-training" },
    ]
  },
  {
    id: "engineering",
    title: "EPC and Asset Integrity",
    slug: "engineering",
    icon: Wrench,
