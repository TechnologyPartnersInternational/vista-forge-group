...
export const services: Service[] = [
    ...
    subServices: [
      {
        ...
        shortDesc: "Strategic environmental planning and risk assessment to ensure regulatory compliance and sustainable project outcomes through the entire lifecycle.",
      ...
      },
      {
        ...
        shortDesc: "Proactive environmental media sampling and analysis to ensure industrial operations remain safe and compliant with statutory regulations.",
      ...
      },
      {
        ...
        shortDesc: "Comprehensive site characterization and ESG risk identification for asset investments and acquisitions to protect value and manage liabilities.",
      ...
      },
      {
        ...
        shortDesc: "Expert advisory on GHG reporting, ESG risks, and sustainability strategies tailored to reduce impact while maintaining business growth.",
      ...
      },
      {
        ...
        shortDesc: "Managing social impacts and community welfare through SIAs and Resettlement Plans, aligned with UN SDGs and global best practices.",
      ...
      },
      {
        ...
        shortDesc: "Advanced measurement and modeling of air quality, noise, and stack emissions using both handheld and IoT-based monitoring systems.",
      ...
      },
      {
        ...
        shortDesc: "Innovative clean-up and spill control solutions for hazardous contamination sites, restoring them to meet environmental safety standards.",
      ...
      },
      {
        ...
        shortDesc: "Expert water resource optimization and subsurface water management, integrating scientific data with regulatory compliance.",
      ...
      },
      {
        ...
        shortDesc: "Scientific subsurface investigations and foundation design using seismic, GPR, and geotechnical testing for infrastructure stability.",
      ...
      },
      {
        ...
        shortDesc: "Advanced spatial data management and remote sensing for situational awareness, engineering planning, and informed decision-making.",
    ...
    subServices: [
      {
        ...
        shortDesc: "Accredited, world-class environmental testing for water, soil, air, and solids, providing precise data and quality-assured analytical reporting.",
      ...
      },
      {
        ...
        shortDesc: "On-site analytical support via fully equipped mobile units (AAS, GC), delivering rapid results in challenging and remote environments.",
      ...
      },
      {
        ...
        shortDesc: "Specialized environmental toxicology testing on marine and freshwater organisms to comply with OECD and EGASPIN standards.",
      ...
      },
      {
        ...
        shortDesc: "Comprehensive refined product testing, crude assays, and production chemistry troubleshooting to optimize processes and ensure fuel quality.",
      ...
      },
      {
        ...
        shortDesc: "Advanced crude oil analysis and chemical biomarker identification to determine origin, history, and spill source attribution.",
    ...
    subServices: [
      {
        ...
        shortDesc: "Strategic, resource-efficient management of solid waste covering generation, segregation, recovery, and disposal for a sustainable circular economy.",
      ...
      },
      {
        ...
        shortDesc: "High-temperature thermal treatment for hazardous and industrial waste streams, ensuring complete contaminant destruction with strict emission controls.",
      ...
      },
      {
        ...
        shortDesc: "Advanced heat-based separation for remediating PCB-contaminated soils, oily sludges, and industrial hazardous waste with high efficiency.",
      ...
      },
      {
        ...
        shortDesc: "Developing compliant waste management plans and regulatory procedures to protect the environment and align with industrial standards.",
    ...
    subServices: [
      {
        ...
        shortDesc: "Conceptual and FEED for energy and infrastructure projects, utilizing 3D modeling and international engineering codes (API, ASME, BS).",
      ...
      },
      {
        ...
        shortDesc: "Maximizing the lifecycle of industrial assets through risk-based inspections (RBI), NDT, and holistic integrity management programs.",
  ...
  },
  {
    ...
    subServices: [
      ...
      {
        id: "data-management",
        slug: "data-management-reporting",
        title: "Data Management & Reporting",
        shortDesc: "Rigorous verification, statistical modeling, and efficient storage of environmental data to provide actionable business insights.",
        fullDesc: "As a leading provider of environmental consulting services, TPI specializes in data management and reporting. We understand the importance of accurate and reliable data in making informed decisions about the environment and our impact on it.\n\nOur team of highly trained professionals has the expertise to help your organization manage and analyze environmental data through efficient storage, rigorous verification systems, and advanced analytical techniques like statistical modeling to extract valuable insights.",
        highlights: [
          "Efficient spatial and environmental data storage",
          "Data collection, verification, and update systems",
    ...
    subServices: [
      {
        ...
        slug: "esg-training",
        title: "ESG Training",
        shortDesc: "Professional development on sustainability standards (GRI, ISO 26000) and environmental risk management for technical teams.",
      ...
      },
      {
        ...
        shortDesc: "Bespoke technical training solutions tailored to your organization's unique requirements, from field workshops to specific curriculum design.",
      ...
      },
      {
        ...
        shortDesc: "Specialized instrumentation and quality control training for environmental laboratories, covering analytical techniques and safety.",
