...
export const projects: Project[] = [
  {
    ...
    summary: "Phased remediation of 14 hydrocarbon-contaminated sites in the Niger Delta, achieving full regulatory closure within 18 months.",
  ...
  },
  {
    ...
    summary: "Comprehensive ESIA for a US$2.8B LNG terminal expansion, meeting both Nigerian and international lender requirements.",
  ...
  },
  {
    ...
    summary: "Design, renovation, and ISO 17025 accreditation of three government environmental laboratories across six Nigerian states.",
